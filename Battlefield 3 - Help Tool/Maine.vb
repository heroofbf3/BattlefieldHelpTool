...
Public Class Maine
    ...
    Private Sub DeumosTheme1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Label9.Text = "Battlefield 3 - Help Tool"
        Label8.Text = "Current Version:  1.0"
        Label6.Text = "MPGH - Multiplayer Game Hacks"
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        ElseIf ComboBox2.SelectedItem = "AS VAL" Then
            ASVAL.Show()
        ElseIf ComboBox2.SelectedItem = "G3" Then
            G3.Show()
    ...
    Private Sub DeumosTheme2_Click(sender As Object, e As EventArgs)

    End Sub

    Private Sub DeumosButton8_Click(sender As Object, e As EventArgs) Handles DeumosButton8.Click
        Application.Exit()
    End Sub
